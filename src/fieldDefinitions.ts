  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        valuePrefix: "/mo",
        description:
          "The regular Lifetime ISA saving you plan to make before age 50. The £4,000 statutory limit applies across all LISA additions in each tax year, including lump sums. This control's £333.33 monthly maximum is a modeller convention for regular saving, not a separate statutory monthly limit.",
      ...
      },
      {
        ...
        format: "age",
        description:
          "The age Lifetime ISA drawdown starts in the retirement model. This modeller assumes later-life withdrawals from age 60 and does not model first-home, terminal-illness or charged early withdrawals.",
        infoUrl: knowledgeLinks.lifetimeIsa,
        infoLinkText: "Lifetime ISA rules",
      },
      {
